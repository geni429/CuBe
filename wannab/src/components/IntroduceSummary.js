  ...
  return (
    <div id="introduce_summary">
      ...
      <div>
        ...
        <section><span className="ft_bold">WannaB는</span> Creator는 원하는 영상 편집자를 <span className="bold">구인</span>, 영상 편집자는 원하는 Creator의 채널에 <span className="bold">구직</span>할 수 있는 공간입니다.</section>
      </div>
    </div>
  );
}
